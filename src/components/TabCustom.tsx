...
const TabCustom = ({ navigation, market, apiData, screenType }: any) => {
  ...
  return (
    <View>
      ...
      <ScrollView horizontal style={styles.customTab}>
        <TouchableOpacity
          style={[
            styles.tabItem,
            { minWidth: '17%' },
      ...
      <View style={styles.customTabContant}>
        ...
        <JodiGame navTabHomeName={navTabHomeName} market={market} apiData={apiDataFun} screenType={screenTypeFun} />

        <ManualGame navTabHomeName={navTabHomeName} market={market} apiData={apiDataFun} screenType={screenTypeFun} />

        <HarrafGame navTabHomeName={navTabHomeName} market={market} apiData={apiDataFun} screenType={screenTypeFun} />

        <CrossingGame navTabHomeName={navTabHomeName} market={market} screenType={screenTypeFun} />

        <CopyPasteGame navTabHomeName={navTabHomeName} market={market} screenType={screenTypeFun} />
