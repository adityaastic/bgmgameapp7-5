            ...
            <View>
              ...
              <View style={{ backgroundColor: '#000000', padding: 20, flexDirection: 'column', display: 'flex', justifyContent: 'space-between' }}>
                ...
                <View style={{ flexDirection: 'row', display: 'flex', justifyContent: 'space-around', paddingTop: 10 }}>
                  <Text style={{ color: '#ffffff', alignSelf: 'flex-start' }}>Win Amount :{wallet?.winning}</Text>
                  <Text style={{ color: '#ffffff', }}>Total Amount :{wallet?.total_amount}</Text>
                </View>
              </View>
                        ...
                        market.status && (
                          <View key={market.id}>
                            {isTimeNotPassed(market.close_time) &&
                              ...
                              <TouchableOpacity
                                onPress={() => navigation.navigate("MoringStarScreen", { market })}
                              >
